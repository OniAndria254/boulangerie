...
<div class="main-wrapper">
    <nav class="sidebar">
        ...
        <div class="sidebar-body ps ps--active-y">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#insertion" role="button" aria-expanded="false" aria-controls="insertion">
                    ...
                    <div class="collapse" id="insertion">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="/uniteMesure/add" class="nav-link">Unité de mesure</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="/recette/add" class="nav-link">Recette</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="affichage">
                        <ul class="nav sub-menu">
                            ...
                            <li class="nav-item">
                                <a href="/recette/list" class="nav-link">Recette</a>
                            </li>
                            <li class="nav-item">
